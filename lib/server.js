...
exports.start = function(callback) {
    ...
    function unknownMethodHandler(req, res) {
        if (req.method.toLowerCase() === 'options') {
            ...
            var allowHeaders = ['Accept', 'Accept-Version', 'Content-Type', 'Api-Version', 'Origin', 'X-Requested-With', 'X-Noserv-Session-Token', 'X-Noserv-Application-Id', 'X-Noserv-Rest-Api-Key', 'X-Noserv-Master-Key', 'X-Noserv-Javascript-Key']; // added Origin & X-Requested-With
    ...
    function setupServer(server) {
        ...
        server.server.timeout = 10 * 60 * 1000;
