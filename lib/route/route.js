...
module.exports = function(server, container) {
    ...
    server.get('/1/:_module', route);
    server.get('/1/:_module/:_query1', route);
    server.get('/1/:_module/:_query1/:_query2', route);
    server.post('/1/:_module', route);
    server.post('/1/:_module/:_query1', route);
    server.post('/1/:_module/:_query1/:_query2', route);
    server.put('/1/:_module', route);
    server.put('/1/:_module/:_query1', route);
    server.put('/1/:_module/:_query1/:_query2', route);
    server.del('/1/:_module', route);
    server.del('/1/:_module/:_query1', route);
    server.del('/1/:_module/:_query1/:_query2', route);
    ...
    function route(req, res, next) {
        ...
        container.log.info('http request', reqData);
        ...
        container.getService('').then(function(service) {
            ...
            service.send('request', reqData, function(err, response) {
                ...
                container.log.info('http response', response.data);
